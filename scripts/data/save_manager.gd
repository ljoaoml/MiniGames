...
func save_game() -> void:
	...
	var data: Dictionary = {
		...
		"animal_inventory": Economy.animal_inventory,
...
func load_game() -> bool:
	...
	var animal_inv: Dictionary = parsed.get("animal_inventory", {})
	for animal_id in Animals.ANIMALS.keys():
		Economy.animal_inventory[animal_id] = int(animal_inv.get(animal_id, 0))
